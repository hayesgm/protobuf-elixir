defmodule Protobufex.Protoc.Generator do
  alias Protobufex.Protoc.Generator.Message, as: MessageGenerator
  alias Protobufex.Protoc.Generator.Enum, as: EnumGenerator
  alias Protobufex.Protoc.Generator.Service, as: ServiceGenerator
