defmodule Protobufex.Protoc.Template do
  @msg_tmpl Path.expand("./templates/message.ex.eex", :code.priv_dir(:protobufex))
  @enum_tmpl Path.expand("./templates/enum.ex.eex", :code.priv_dir(:protobufex))
  @svc_tmpl Path.expand("./templates/service.ex.eex", :code.priv_dir(:protobufex))
